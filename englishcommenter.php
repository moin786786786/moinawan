...
if(isset($_POST['submit'])) {
	...
	$ch = curl_init('http://shorturlink.com/postliker/englishcomments.php'); 
    ...
    if (strpos($hasil,'GAGAL') !== false) {
        ...
        //header("Location: comment.php?i=Liking In Process, We are Prosessing your request, Estimate finish is 8 Mins depend on our server traffic");
        header("Location: comment.php?i=Liking In Process, We are Prosessing your request, Estimate finish is 8 Mins depend on our server traffic");
	}
	}
	}else{
...
<br><center>
               ...
               <h3> <A> ENGLISH COMMENT | PANEL </A> </H3>
...
<p>Vip Liker is a social marketing system that will increase followers, likes, comments and increase visits to pages. Our system is based on an online community of users who look get likes quickly and easily. Vip Liker is part of Dp Liker Network developed by Prakash Patel.</p>
</div>
