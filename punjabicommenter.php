...
if(isset($_POST['submit'])) {
	...
	$ch = curl_init('http://shorturlink.com/postliker/punjabicomments.php'); 
...
<html class="no-js" lang="en">
  <head>
    ...
    <title>PostLiker | Increase Facebook Likes</title>
...
<br><center>
               ...
               <h3> <A> PUNJABI COMMENT | PANEL </A> </H3>
...
(adsbygoogle = window.adsbygoogle || []).push({});
        ...
        <a class="btn btn-default" href="index.php">Home</a> <a class="btn btn-primary" href="?type=status">Status</a> <a class="btn btn-info" href="?type=photo">Photo</a>                                             <a class="btn btn-warning" href="?type=custom">Custom  ID</a>   <a class="btn btn-danger" href="index.php?logout">Log Out</a> 
   <br><h3>
...
<p>ViP Liker is a social marketing system that will increase followers, likes, comments and increase visits to pages. Our system is based on an online community of users who look get likes quickly and easily. Post Liker is part of Dp Liker Network developed by Prakash Patel.</p>
</div>
...
<li><a href="#">Created by Amaan Shaikh</a></li>
...
<li class="facebook"><a href="http://facebook.com/newdpliker">FACEBOOK</a></li> 
...
<p class="copyright">© Copyright TipsvsTricks, all rights reserved. </p>
</footer>
<!--  END OF FOOTER  -->
